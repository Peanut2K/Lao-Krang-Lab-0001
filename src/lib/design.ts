...
/**
 * All 77 provinces — suggestions for the location fields, not a limit. The
 * district and community lists stay as northern examples because there is no
 * bundled dataset for them; both fields accept any typed or geocoded value.
 */
export const PROVINCES = [
  ...
  "อำนาจเจริญ", "อุดรธานี", "อุตรดิตถ์", "อุทัยธานี", "อุบลราชธานี", "กรุงเทพมหานคร",
];
